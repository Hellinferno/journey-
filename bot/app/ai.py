"""
AI Invoice Analyzer
Uses Google Gemini 2.5 Flash or NVIDIA Kimi K2.5 to extract invoice data from images
"""
...
def analyze_invoice(image_path: str) -> InvoiceData:
    ...
    Priority: NVIDIA Kimi K2.5 > Google Gemini 2.5 Flash
    ...
    Returns:
        InvoiceData object with extracted information
    """
    # Try NVIDIA first if API key is available
    if NVIDIA_API_KEY:
        try:
    ...
    raise ValueError("No AI API keys configured. Please set NVIDIA_API_KEY or GOOGLE_API_KEY")
